...
import '../inspection/sub_inspection.dart';

class VehicleRepair extends StatefulWidget {
  const VehicleRepair({Key? key}) : super(key: key);

  @override
  State<VehicleRepair> createState() => _VehicleRepairState();
}

class _VehicleRepairState extends State<VehicleRepair> with SingleTickerProviderStateMixin {
