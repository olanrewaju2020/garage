...
class _SearchMechanicState extends State<SearchMechanic> {
  ...
  return Column(
            ...
            children: [
                      ...
                      icon: GestureDetector(
                        onTap: ()  {
                          setState(() async {
                            ...
                            provider.recentSearchLocation = searchQueryCtrl.text;
                          });
                        },
              ...
              if(recentSearch?.isNotEmpty ?? false)
              ...
              const SizedBox(
                ...
                SizedBox(
                  ...
                  child: Column(
                    children: List.generate(recentSearch?.length ?? 0, (index) => GestureDetector(
                      onTap: () => Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => ListOfMechanic(location: searchQueryCtrl.text))),
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Image(
                          ...
                          Padding(
                            ...
                            child: Text(recentSearch![index], style: const TextStyle(
